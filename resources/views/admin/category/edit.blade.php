...
<div class="col-sm-4 col-sm-offset-4">
    <form class="form-inline" role="form" method="post" action="/admin/products/edit-category">
        {{ csrf_field() }}
        <div class="form-group">
            <label class="sr-only">Category name</label>
            <input type="hidden" name="hashed_id"  value="@if(isset($category)) {{ $category->hashed_id}} @endif">
